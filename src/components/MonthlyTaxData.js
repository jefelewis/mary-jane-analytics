  ...
  datasets: [
    {
      ...
      pointBorderColor: '414548',
      pointBackgroundColor: '#414548',
      pointBorderWidth: 5,
      pointHoverRadius: 8,
      pointHoverBackgroundColor: '#414548',
      pointHoverBorderColor: '#414548',
    ...
    },
    {
      ...
      fill: false,
      lineTension: 0.1,
      backgroundColor: '#69018d',
      borderColor: '#69018d',
      borderCapStyle: 'butt',
      borderDash: [],
      borderDashOffset: 0.0,
      borderJoinStyle: 'miter',
      pointBorderColor: '69018d',
      pointBackgroundColor: '#69018d',
      pointBorderWidth: 5,
      pointHoverRadius: 8,
      pointHoverBackgroundColor: '#69018d',
      pointHoverBorderColor: '#69018d',
      pointHoverBorderWidth: 2,
      pointRadius: 2,
      // Distance Of Hover Zone
      pointHitRadius: 25,
    },
    {
      ...
      borderDashOffset: 0.0,
      borderJoinStyle: 'miter',
      pointBorderColor: '329932',
      pointBackgroundColor: '#329932',
      pointBorderWidth: 5,
      pointHoverRadius: 8,
      pointHoverBackgroundColor: '#329932',
      pointHoverBorderColor: '#329932',
      pointHoverBorderWidth: 2,
      pointRadius: 2,
      // Distance Of Hover Zone
      pointHitRadius: 25,
    ...
    },
    {
      ...
      borderDashOffset: 0.0,
      borderJoinStyle: 'miter',
      pointBorderColor: 'f6546a',
      pointBackgroundColor: '#f6546a',
      pointBorderWidth: 5,
      pointHoverRadius: 8,
      pointHoverBackgroundColor: '#f6546a',
      pointHoverBorderColor: '#f6546a',
      pointHoverBorderWidth: 2,
      pointRadius: 2,
      // Distance Of Hover Zone
      pointHitRadius: 25,
    ...
    },
    {
      ...
      fill: false,
      lineTension: 0.1,
      backgroundColor: '#a51874',
      borderColor: '#a51874',
      borderCapStyle: 'butt',
      borderDash: [],
      borderDashOffset: 0.0,
      borderJoinStyle: 'miter',
      pointBorderColor: 'a51874',
      pointBackgroundColor: '#a51874',
      pointBorderWidth: 5,
      pointHoverRadius: 8,
      pointHoverBackgroundColor: '#a51874',
      pointHoverBorderColor: '#a51874',
      pointHoverBorderWidth: 2,
      pointRadius: 2,
      // Distance Of Hover Zone
      pointHitRadius: 25,
